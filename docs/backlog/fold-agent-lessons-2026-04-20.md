---
title: Fold agent log lessons (2026-04-20)
category: meta
state: available
---

Auto-generated on 2026-04-20. `docs/agent-logs/` has accumulated 55 findings files; fold their durable lessons into CLAUDE.md (or the relevant skill file) and delete the consumed logs so the count resets.
